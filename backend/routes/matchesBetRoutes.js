...
const { getMatchesBet, setMatchesBet, updateMatchBet, deleteMatchesBet, getMaxWin} = require('../controllers/matchesBetController');
const { protect } = require('../middleware/authMiddleware')


router.route('/').get(protect, getMatchesBet).post(protect, setMatchesBet) //shortcut ORIGIN
router.route('/:id').put(protect, updateMatchBet).delete(protect, deleteMatchesBet) //shortcut
